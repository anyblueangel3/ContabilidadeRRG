...
public class ConfiguracaoBanco {
    ...
    static {
        try (InputStream input = ConfiguracaoBanco.class
            ...
            if (input == null) {
                JOptionPane.showMessageDialog(null, "ERRO: config.properties não encontrado dentro do JAR!");
            } else {
                propriedades.load(input);
                JOptionPane.showMessageDialog(null,
                        "Config carregado com sucesso:\n"
                        + "URL: " + propriedades.getProperty("banco.url") + "\n"
                        + "Usuário: " + propriedades.getProperty("banco.usuario") + "\n"
                        + "Senha: " + propriedades.getProperty("banco.senha"));
            }
